...
lst1 = [i for i in range(-A, A+1)]
print (lst1)
r = int(input('укажите номер элемента из списка '))
t = int(input('укажите еще один номер элемента из списка '))
y = int(input('укажите еще одну позицию элемента из списка '))

print (lst1[r] * lst1[t] * lst1[y] )
