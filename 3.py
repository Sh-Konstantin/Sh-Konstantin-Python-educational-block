...
lst1 = [-A,A]
elem1 = int(input('укажите номер элемента из списка '))
elem2 = int(input('укажите еще один номер элемента из списка '))
elem3 = int(input('укажите еще один номер элемента из списка '))
